    ...
    <div className="app-shell">
      ...
      <main className="main">
        <header className="topbar">
          ...
          <div className="topbar-actions"><button className="secondary" onClick={() => go('relatorio-executivo')}>Relatório executivo</button><button className="secondary" onClick={() => go('usuarios')}>Usuários e acessos</button><div className="status-pill"><span className="status-dot" />Ambiente de demonstração</div></div>
        </header>
